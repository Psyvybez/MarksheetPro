...
function defineSteps() {
  tutorialSteps = [
    ...
    },
    {
      ...
      // --- UPDATED STEP 7 ---
      content:
        'Add your units and set their term weights (they must total 100%). You can also enable a "Final Assessment" at the bottom and set its overall weight. Click "Save Changes" when done.',
      isWaiting: true,
      waitForModalClose: true,
    ...
    },
    {
      ...
      title: 'Add a Student',
      content:
        'Enter a student\'s name and click "Add & Next". You can add as many as you want. Click "Done" when you\'re finished.',
      isWaiting: true,
      waitForModalClose: true,
    },
    {
    ...
    },
    {
      ...
      // --- UPDATED STEP 12 ---
      content:
        'Click "+ Add Assignment". Give it a name, weight (how many times it counts), and the total marks for K, T, C, and A. Then, click "Save Changes".',
      isWaiting: true,
      waitForModalClose: true,
    },
    {
      ...
      title: 'Enter Grades',
      content:
        'Now you can type grades directly into the grid. All changes are saved automatically. Click "Next" to finish.',
      isWaiting: false,
    },
    {
      ...
      content:
        'That\'s it! You can explore other features like Attendance or PDF Exports. Click "My Account" to manage your profile.',
      isWaiting: false,
    },
  ];
}
...
function handleTutorialClick(e) {
  ...
  if (
    !step.isWaiting ||
    step.listenFor === 'change' ||
    step.listenFor === 'input' ||
    step.listenFor === 'enter-or-blur'
  ) {
    return;
  }
 ...
 */
function handleTutorialInput(_e) {
  // --- FIX 3: DEFINE STEP ---
  if (currentStep >= tutorialSteps.length) return;
  const step = tutorialSteps[currentStep];
  // --- END FIX 3 ---
